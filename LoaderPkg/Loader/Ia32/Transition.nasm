...
ASM_PFX(CallKernelThroughGateAsm):
    ...
    mov eax, cr0
    and eax, 0x7FFFFFFF ; cr0.pg is 31 bit of cr0
    mov cr0, eax
...
AsmWithOurGdt:
    ...
    ; LAB 2: Your code here:
    mov eax, cr4  ; (pae - 5 bit, pge - 7 bit)
    or eax, 1 << 5; cr4.pae=1
    or eax, 1 << 7; cr4.pge=1 
    mov cr4, eax
    ...
    ; LAB 2: Your code here:
    mov ecx, 0xC000_0080; chose EFER
    rdmsr; read EFER
    or eax, 1 << 8 ; IA32_EFER.LME = 1
    or eax, 1 << 11; IA32_EFER.NXE = 1
    wrmsr
    ...
    or eax, 1 << 18 ; cr0.AM=1
    or eax, 1 << 16 ; cr0.WP=1
    mov cr0, eax
